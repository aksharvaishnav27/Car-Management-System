    ...
    <section class="car-cards">
        ...
        <% try {
            ...
            PreparedStatement preparedStatement = connection.prepareStatement("SELECT * FROM old_car_model" +
                    " WHERE  not EXISTS (SELECT 1 FROM bargain_request WHERE bargain_request.accept_time IS  not NULL and old_car_model.car_id = bargain_request.car_id) and old_car_model.seller_id !=? ");
        ...
        %>
            ...
            <div class="card-head">
                <h2><%=resultSet.getString("seller_id") %></h2>
                   ...
                   <input type="hidden" name="seller_id" id="seller_id" value="<%= resultSet.getString("seller_id") %>">
