        ...
        <section class="search-section">
            ...
            <div class="filter-buttons">
                <table>
                    ...
                    <tr>
                        <td><label class="filter-button"><input type="checkbox" name ="priceRange"  id="5" value="5" > 20 lakh to 30 lakh</label></td>
                        <td><label class="filter-button"><input type="checkbox" name ="priceRange"  id="6" value="6" > 30 lakh to 50 lakh</label></td>
                        <td><label class="filter-button"><input type="checkbox" name ="priceRange"  id="7" value="7" > 50 lakh to 80 lakh</label></td>
                        <td><label class="filter-button"><input type="checkbox" name ="priceRange"  id="8" value="8" > 80 lakh and above</label></td>
